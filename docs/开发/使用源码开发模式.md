...
如果你有自己的 Gitea 或其他 Git 服务器，可以添加为额外的远程备份：

```bash
git remote add gitea https://gitea.inote.live:3232/1203/nocobase.git
```
...
应该看到：
```
gitea     https://gitea.inote.live:3232/1203/nocobase.git (fetch)
gitea     https://gitea.inote.live:3232/1203/nocobase.git (push)
...
# （可选）备份到 gitea
git push gitea feature/plugin-approval-flow
```
